 ...
 * este archivo le saca las vocales a una cadena por recursión, bien tranquilo.
 */
...
public static void main(String[] args) {
    ...
    String s = "Escuela"; // el string puede variar según lo que se quiera modificar, parcero
